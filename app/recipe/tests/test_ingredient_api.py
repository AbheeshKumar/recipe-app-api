...
class PrivateIngredientAPITests(TestCase):
    ...
    def test_retreive_ingredients(self):
        ...
        Ingredient.objects.create(user=self.user, name="Kales")
    ...
    def test_filtered_ingredients_unique(self):
        ...
        recipe1 = Recipe.objects.create(title="Eggs Benedict",
                                        ...
                                        price=Decimal('7.60'),
                                        user = self.user)
        recipe2 = Recipe.objects.create(title="Eggs Benedict",
                                        time_minutes=60,
                                        price=Decimal('7.60'),
                                        user = self.user)
